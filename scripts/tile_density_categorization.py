...
# Paths
tiles_dir = r"/mnt/SRGAN/SRGAN_CustomDataset/pre_process/delft/tiles_64x64"  # Tiles folder
land_use_path = r"/mnt/SRGAN/SRGAN_CustomDataset/pre_process/delft/land_use_delft.shp"  # Land use shapefile
