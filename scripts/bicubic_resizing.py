...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default=r"C:\Users\mike_\OneDrive\Desktop\MSc Geomatics\Master Thesis\Codebases\SRGAN_CustomDataset\result\p3_bicubic",
