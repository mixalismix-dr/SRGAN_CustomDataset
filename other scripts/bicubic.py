...
def resize_images(input_dir, output_dir, scale=4, resampling="bicubic", mode="down"):
    """Resize georeferenced RGB TIFF images while preserving CRS using PIL Bicubic resampling."""
    ...
    for filename in os.listdir(input_dir):
        if filename.lower().endswith(".tif"):
            ...
            with rasterio.open(input_path) as src:
                ...
                # Resize with PIL using Bicubic
                resized_pil = pil_image.resize(new_size, RESAMPLING_METHODS["bicubic"])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_dir", type=str, default=r"D:\Super_Resolution\Delft\HR\synthetic_lr_from_hr\tiles_64",
                        help="Path to the input directory containing images.")
    parser.add_argument("--output_dir", type=str, default=r"D:\Super_Resolution\Delft\HR\generated_hr_bic_upscale\tiles_256",
    ...
    resize_images(args.input_dir, args.output_dir, args.scale, "bicubic", args.mode)
