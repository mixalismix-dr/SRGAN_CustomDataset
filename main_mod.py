...
parser.add_argument("--pre_train_epoch", type = int, default = 50)
parser.add_argument("--fine_train_epoch", type = int, default = 10)
...
parser.add_argument("--mask_path", type = str, default='other scripts/output_mask_tiles')
